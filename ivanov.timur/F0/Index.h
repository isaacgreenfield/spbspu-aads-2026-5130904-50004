...
namespace idx {
  ...
  private:
    ...
    explicit iterator(TreeIterator it):
    treeIt_(it)
    {}
  };
  ...
  private:
    ...
    explicit const_iterator(TreeConstIterator it):
    treeIt_(it)
    {}
  };
